...
%                                                          %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [bbox,bbX,faces,bbfaces,parts,partsmatrix] = detectFaceParts(detector,X,thick)
...
if( nargout > 2 )
 ...
 for i=1:size(bbox,1)
  ...
  partsmatrix(bbox(i,6):bbox(i,6)+bbox(i,8)-1,bbox(i,5):bbox(i,5)+bbox(i,7)-1,:) = X(bbox(i,6):bbox(i,6)+bbox(i,8)-1,bbox(i,5):bbox(i,5)+bbox(i,7)-1,:);
  partsmatrix(bbox(i,10):bbox(i,10)+bbox(i,12)-1,bbox(i,9):bbox(i,9)+bbox(i,11)-1,:) = X(bbox(i,10):bbox(i,10)+bbox(i,12)-1,bbox(i,9):bbox(i,9)+bbox(i,11)-1,:);
  partsmatrix(bbox(i,14):bbox(i,14)+bbox(i,16)-1,bbox(i,13):bbox(i,13)+bbox(i,15)-1,:) = X(bbox(i,14):bbox(i,14)+bbox(i,16)-1,bbox(i,13):bbox(i,13)+bbox(i,15)-1,:);
  partsmatrix(bbox(i,18):bbox(i,18)+bbox(i,20)-1,bbox(i,17):bbox(i,17)+bbox(i,19)-1,:) = X(bbox(i,18):bbox(i,18)+bbox(i,20)-1,bbox(i,17):bbox(i,17)+bbox(i,19)-1,:);
  parts(bbox(i,6):bbox(i,6)+bbox(i,8)-1,bbox(i,5):bbox(i,5)+bbox(i,7)-1,:) = X(bbox(i,6):bbox(i,6)+bbox(i,8)-1,bbox(i,5):bbox(i,5)+bbox(i,7)-1,:);
  parts(bbox(i,10):bbox(i,10)+bbox(i,12)-1,bbox(i,9):bbox(i,9)+bbox(i,11)-1,:) = X(bbox(i,10):bbox(i,10)+bbox(i,12)-1,bbox(i,9):bbox(i,9)+bbox(i,11)-1,:);
  parts(bbox(i,14):bbox(i,14)+bbox(i,16)-1,bbox(i,13):bbox(i,13)+bbox(i,15)-1,:) = X(bbox(i,14):bbox(i,14)+bbox(i,16)-1,bbox(i,13):bbox(i,13)+bbox(i,15)-1,:);
  parts(bbox(i,18):bbox(i,18)+bbox(i,20)-1,bbox(i,17):bbox(i,17)+bbox(i,19)-1,:) = X(bbox(i,18):bbox(i,18)+bbox(i,20)-1,bbox(i,17):bbox(i,17)+bbox(i,19)-1,:);
 end
end
